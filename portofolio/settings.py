...
SECRET_KEY = 'django-insecure-%go9i2(b*9mg*t9f2^2si-hm8-lfs9$u=y!w)%0t$xj6%3llm&'
...
# register templates/ and static/ to indicate Django that here lies HTML pages & static assets
STATIC_URL = 'static/'
